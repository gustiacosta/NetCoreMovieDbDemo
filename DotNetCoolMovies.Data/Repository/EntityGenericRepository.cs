...
namespace DotNetCoolMovies.Data.Repository
{
    public class EntityGenericRepository<TContext> : IEntityGenericRepository
        where TContext : CoolMoviesAppContext
    {
        protected CoolMoviesAppContext context;

        public EntityGenericRepository(TContext ctx)
        {
            this.context = ctx;
        }
